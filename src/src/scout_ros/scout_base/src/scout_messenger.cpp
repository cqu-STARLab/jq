...
namespace westonrobot
{
  ...
  void ScoutROSMessenger::PublishStateToROS()
  {
    ...
    auto ranger_bms = scout_->GetCommonSensorState();
    auto state = ranger_bms.bms_basic_state;
    ...
    else
    {
     ...
     // bms
     bms_status.SOC = state.battery_soc;
     bms_status.SOH = state.battery_soh;
     bms_status.battery_voltage = state.voltage;
     bms_status.battery_current = state.voltage;
     bms_status.battery_temperature = state.temperature;
